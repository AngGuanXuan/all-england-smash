...
export default async function LeaderboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-slate-200 p-8 flex flex-col items-center">
      ...
      <div className="relative z-10 w-full max-w-4xl mt-12 flex flex-col gap-10">
        ...
        {highestDifferential.length > 0 && (
          <div
            className="relative mt-8 glass border-none rounded p-8 backdrop-blur-md shadow-2xl overflow-hidden
            before:content-[''] before:absolute before:-top-20 before:-left-20 before:w-64 before:h-64 before:bg-purple-600/20 before:rounded-full before:blur-3xl before:animate-float
            after:content-[''] after:absolute after:-bottom-20 after:-right-20 after:w-64 after:h-64 after:bg-emerald-600/20 after:rounded-full after:blur-3xl after:animate-float-reverse"
          >
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 gap-4">
                {highestDifferential.map((match) => (
                  <div
                    key={match.id}
                    className="flex justify-between items-center glass-light border-none p-4 rounded-xl"
                  >
                    <div className="flex items-center gap-4">
                      <span className="text-xs font-mono text-slate-500">
                        #{match.id.slice(0, 4)}....{match.id.slice(-4)}
                      </span>
                      <span
